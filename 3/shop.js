...
function main() {
    let goods = [
        new Good(2, "shoes", "empty", [40,44], 3000),
        new Good(3, "hat", "empty", [37,39], 2000),
        new Good(4, "dress", "empty", [38,40], 5000),
        new Good(5, "shirt", "empty", [41,42], 3500),
        new Good(1, "scarf", "empty", [35,38], 1000),
    ]
    ...
    let basketGoods = [
        new BasketGood(2, "shoes", "empty", [40,44], 3000, 20),
        new BasketGood(3, "hat", "empty", [37,39], 2000, 0),
        new BasketGood(4, "dress", "empty", [38,40], 5000, 6),
        new BasketGood(5, "shirt", "empty", [41,42], 3500, 1),
        new BasketGood(1, "scarf", "empty", [35,38], 1000, 0),
    ]
